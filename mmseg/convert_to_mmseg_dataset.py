...
ROOT = './data'
TRAINJSON = './data/train_all.json'
# VALJSON = './data/val.json'
...
'''
./data/mmseg
./data/mmseg/images/training
./data/mmseg/images/validation
./data/mmseg/annotations/training
./data/mmseg/annotations/validation
./data/mmseg/test
'''
dir_lists = [
